...
//             <div className="w-full max-w-4xl border border-black p-8">
//                 <div className="flex gap-3 border-b border-black pb-3 mb-4">
//                     <button
...
//                 </div>
//                 <textarea
//                     className={`w-full h-64 p-4 border border-black text-lg focus:outline-none focus:ring-2 focus:ring-black resize-none
